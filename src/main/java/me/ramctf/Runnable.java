        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if(GameProperties.blueFlagLocation != null){
                    ...
                    Location particleLocation = GameProperties.blueFlagLocation.clone().add(0, 1, 0);
                ...
                if(GameProperties.redFlagLocation != null){
                    ...
                    Location particleLocation = GameProperties.redFlagLocation.clone().add(0, 1, 0);
                    particleLocation.getWorld().spawnParticle(Particle.REDSTONE, particleLocation, 25, 0.2, 0.4, 0.2, dustOptions);
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                for(Player p : Bukkit.getOnlinePlayers()){
                    String team = Teams.getTeam(p);
                    if(team.equalsIgnoreCase("Blue")){
                        p.teleport(GameProperties.blueFlagLocation.clone().add(0, 1, 0));
                    } else if(team.equalsIgnoreCase("Red")){
                        p.teleport(GameProperties.redFlagLocation.clone().add(0, 1, 0));
                    }
                }
                cancel();
